...
class NewsAISummary(Base):
    ...
    status: Mapped[int] = mapped_column(SmallInteger, default=SummaryStatus.NORMAL,comment="状态")#1:正常 2:失败 0:生成中
    ...
    news=relationship("News",back_populates="summary")#relationship